...
public class OrderController {
    ...
    public ResponseEntity createOrder(
        ...
        @RequestBody final OrderCreateRequest orderCreateRequest, final HttpSession httpSession) {
        String customerId = httpSession.getId();
        final OrderResponse orderResponse = orderService.create(shopId, orderCreateRequest, customerId);
    ...
    public ResponseEntity findByCustomer(final HttpSession httpSession) {
        List<OrderResponse> orderResponses = orderService.findByCustomerId(httpSession.getId());
        return ResponseEntity.ok(orderResponses);
    }
